                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control " id="rider_id" name="rider_id">
                                            @php
                                            $riderid = DB::table('rider_activities')
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" name="billing_month_from" class="form-control" placeholder="Filter By Billing Month From" value="{{ request('billing_month_from') }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="billing_month_to">Billing Month To</label>
                                        <input type="date" name="billing_month_to" class="form-control" placeholder="Filter By Billing Month To" value="{{ request('billing_month_to') }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="payout_type">Filter by Payout Type</label>
                                        <select class="form-control " id="payout_type" name="payout_type">
                                            @php
                                            $payoutype = DB::table('rider_activities')
